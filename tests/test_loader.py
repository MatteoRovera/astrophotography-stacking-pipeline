...
def test_classify_filename_prefix_with_underscore():
    # Regression test: a naive `\bbias\b` regex does NOT match "Bias_000"
    # because '_' counts as a word character, so there's no boundary there.
...
def test_classify_filename_single_letter_prefix_convention():
    # DeepSkyStacker-style DSLR sets often abbreviate to one leading letter,
    # e.g. "L_0020_ISO800_240s__18C.CR2", "B_0085_ISO800___20C.CR2".
